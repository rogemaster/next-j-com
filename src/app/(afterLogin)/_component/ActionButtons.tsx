...
type Props = { white?: boolean; post: IPost };
      ...
      queryKeys.forEach((queryKey) => {
        ...
        if (value && 'pages' in value) {
          ...
          if (value.postId === postId) {
            const shallow = {
              ...value,
              Heart: [{ userId: session?.user?.email as string }],
              _count: {
                ...value._count,
